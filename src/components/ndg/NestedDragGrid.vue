<template>
  <div class="ndg">
    ...
    <BoxModal class="modal-show" v-model="modalContent" :modalInfo="modal" ref="modal">
    </BoxModal>
        ...
        setTimeout(() => {
          ...
          this.desks[this.currentDeskNo].boxes.forEach((box, bid) => {
            ...
            let recoverOtherBox = (did, boxId) => {
              ...
              // console.log(
              //   "--recoverOtherBoxs--",
              //   this.desks[did].boxes[boxId].covered ? "覆盖" : "未覆盖"
              // );
            };
